...
TOOLS: list[types.Tool] = [
    ...
    types.Tool(
        name="propose_basic_memory_update",
        description=(
            "Create a reviewed candidate update for the local Basic Memory Chinese "
            "project knowledge base. This only writes a candidate file under "
            "BASIC_MEMORY_CANDIDATE_DIR and never changes D:\\BasicMemory project notes "
        ...
        inputSchema={
            ...
            "properties": {
                "project_slug": {
                    "type": "string",
                    "description": "Project slug under D:\\BasicMemory\\projects, e.g. coord-picker",
                },
                "target_file": {
                    "type": "string",
                    "description": (
                        "Chinese Basic Memory target file, e.g. 修改记录.md, 已知坑点.md, "
                ...
                "reason": {
                    "type": "string",
                    "description": "Why this belongs in durable Basic Memory",
                },
            },
    ...
    types.Tool(
        name="commit_basic_memory_update",
        description=(
            "Commit a previously proposed Basic Memory candidate into the official Chinese "
        ...
        inputSchema={
            ...
            "properties": {
                "candidate_id": {
                    "type": "string",
                    "description": "Candidate id returned by propose_basic_memory_update",
                },
                "confirmed": {
                    "type": "boolean",
                    "description": "Must be true before writing to official Basic Memory notes",
                    "default": False,
                },
            },
...
async def _dispatch(name: str, args: dict[str, Any]) -> dict:
    ...
    if name == "propose_basic_memory_update":
        return await svc.propose_basic_memory_update(
    ...
    if name == "commit_basic_memory_update":
        return await svc.commit_basic_memory_update(
...
async def _run() -> None:
    ...
    client_cls = EverOSClient if config.EVERMEMOS_BACKEND == "everos" else EverMemosClient
